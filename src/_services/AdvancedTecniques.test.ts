...
describe('AdvancedTecniques', () => {
  ...
  const map1 = new NumericMap('DAINARI MOZZU', '1950-12-26', '2021-01-07')
  const am1 = new AdvancedTecniques(map1)
  const map2 = new NumericMap('ODRAUDE USSOR', '1979-03-17', '2021-01-07')
  const am2 = new AdvancedTecniques(map2)
